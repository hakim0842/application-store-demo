export default function HeroButton({ image, children, link }) {
  return (
    <button className='btn bg-white shadow-sm text-black btn-sm md:btn-md lg:btn-lg border-0 hover:bg-linear-to-bl hover:from-violet-500 hover:to-fuchsia-500 hover:text-white transition-all duration-150 hover:-translate-y-0.5 active:translate-0'>
      <a
